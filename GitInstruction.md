...
ветка master - чистовая ветка для файла
далее создаем дополнительные ветки для работы git checkout -b название ветки, либо git branch __название ветки___, далее переходим на дополнительную ветку git checkout ____название ветки___
