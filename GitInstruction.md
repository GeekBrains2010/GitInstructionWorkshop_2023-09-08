...
* GitLab — открытое, мощное, безопасное, эффективное, надежное, наполненное разным функционалом приложение для разработки ПО на разных этапах жизненного цикла.
* Bitbucket — это мощная, полностью масштабируемая и высокопроизводительная платформа для разработчиков, предназначенная специально для профессиональных команд. Начинающие пользователи и команды, работающие над проектами с открытым исходным кодом бесплатно получают доступ к аккаунту Bitbucket и ко многим его функциям.
