...
1. git clone repository_address.git - команда клонирования репозитория, находящегося по ссылке repository_address.git;
2. echo "text" >> README.md - создаёт файл с названием "README.md" с текстом "text";
3. git remote add origin repository_address.git - команда связывает локальный репозиторий с удалённым;
4. git push -u origin main - связывает локальную ветку с веткой удалённого репозитория;
5. git pull - команда для получения последних изменений из удалённого репозитория;
6. git push - команда для отправки последних изменений на удалённый репозиторий.
