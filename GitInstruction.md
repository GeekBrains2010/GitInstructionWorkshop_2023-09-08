...
В мире уже много написано про Git. Я рекомендую посетить следующий сайт: https://learngitbranching.js.org/?locale=ru_RU - в нем можно потренироваться в создании веток и в "путешествиях" по файлу с помощью Git.
