...
Инструкция-описание принципов работы с программой Git.
...
1. Создать каталог (папку) для хранения репозитория
2. Войти в неё с помощью программы Git
3. Инициализировать папку для работы с помощью команды "git init"
